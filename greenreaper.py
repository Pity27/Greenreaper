...
\033[1;92m        ::::::`:::::;' \033[1;94m /  /   `#                
\033[1;96m|#########################################|
\033[1;96m|###| Author By : YUDANI   .          |###| 
\033[1;96m|###| code      : Python2             |###|
\033[1;96m|###| Team      : SWORD X CYB3R       |###|
...
curdir = os.getcwd()
print ("\033[1;91minput web url \033[1;95m[ex : www.SiteTarget.com ]")
host=raw_input( "\033[1;94mTarget Website : " )
print ("\033[1;91minput port \033[1;95m[ex : 8080 ]")
port=input("\033[1;94mPortnya : ")
connect=50000
